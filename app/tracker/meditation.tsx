      ...
      case "Statistics":
        return (
          <View style={styles.statisticsContainer}>
            <Text style={[styles.pastHeader, { color: "white" }]}>
              Past progress
            </Text>
            ...
            <View style={styles.statisticBoxContainer}>
              ...
              <View
                style={[
                  styles.statisticBox,
                  { backgroundColor: dailyGoalBoxColor },
                ]}
              >
                  ...
                  {previousSessions.map((item) => (
                    <View style={styles.sessionHistoryBox} key={item.id}>
                      <Text style={styles.sessionHistoryText}>
                        {item.completionDate.toLocaleString([], {
                          dateStyle: "short",
                          timeStyle: "short",
                        })}
                      </Text>
        ...
        return (
          <View>
                ...
                meditationSessions.map((session) => (
                  ...
                  >
                    ...
                    <View style={styles.meditateInfoContainer}>
                      <Text style={styles.meditateInfoHead}>
                        {session.name}
                      </Text>
            ...
            {selectedSession && !sessionStarted && (
              <View>
                <>
                  <Text style={styles.meditateSubHeader}>
                      ...
                      intro.map((eSession) => (
                        ...
                        >
                          <View style={styles.exerciseIntroInfoContainer}>
                            <Text style={styles.exerciseIntroInfoHead}>
                              {eSession.name}
                            </Text>
